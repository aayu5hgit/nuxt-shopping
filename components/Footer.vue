    ...
    <section class="py-10 bg-gray-50 sm:pt-16 lg:pt-24">
      <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        >
          <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
            ...
            <p class="text-base leading-relaxed text-gray-600 mt-7">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Necessitatibus harum et veritatis! Laudantium, ipsum officia?
            </p>

            <ul class="flex items-center space-x-3 mt-9">
              <li>
                <NuxtLink
                  to="https://twitter.com/_aayu5h"
                  title=""
                  class="flex items-center justify-center text-white transition-all duration-200 bg-[#111827] rounded-full w-7 h-7 hover:bg-[#06d6a0] focus:bg-blue-600"
                >
                  <svg
                    class="w-4 h-4"
              ...
              <li>
                <NuxtLink
                  to="https://instagram.com/aayu5h._"
                  title=""
                  class="flex items-center justify-center text-white transition-all duration-200 bg-[#111827] rounded-full w-7 h-7 hover:bg-[#06d6a0] focus:bg-blue-600"
                >
                  <svg
            ...
            <form action="#" method="POST" class="mt-6">
              <div>
                ...
                <input
                  ...
                  id="email"
                  placeholder="Email"
                  class="block w-full p-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:border-[#12B488] caret-[#12B488]"
                />
              </div>
        ...
        <p class="text-sm text-center text-gray-600">
          © Copyright 2023, All Rights Reserved by Attire
        </p>
      </div>
    </section>
  </div>
